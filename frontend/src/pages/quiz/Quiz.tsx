  ...
  return (
    <div className="min-h-[calc(100vh-69px)] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-xl">
        <div
          className="bg-base-200 rounded-lg shadow-2xl p-8 md:p-12 border border-base-300 flex flex-col"
        ...
        >
          ...
          {/* Title */}
          <h1 className="text-3xl lg:text-4xl font-bold text-center text-base-content mb-2 tracking-tight flex-shrink-0">
            Create Your Quiz
          </h1>

          {/* Description */}
          <p className="text-base text-center text-base-content/70 mb-0 max-w-md mx-auto flex-shrink-0">
